    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            ...
            background: Rectangle {
                ...
                radius: 2
                                                //hovered     //normal
                border.color: control.hovered ? "#FF0000" : "#FF0000"
                border.width: 1
                implicitHeight: 30
            }
        }
        ...
        style: ButtonStyle {
            background: Rectangle {
                ...
                gradient: Gradient {                                      //hovered   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "#FF0000" : "#FF0000" }
                    GradientStop { position: 1 ; color: control.pressed ? "#FF0000" : "#FF0000" }
                }
                implicitHeight: 30
            }
            label: Component {
